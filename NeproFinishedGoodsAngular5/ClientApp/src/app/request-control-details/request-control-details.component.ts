...
export class RequestControlDetailsComponent {
  ...
  rowData1 = [
    { itemno: '1', productname: 'Rice', productnameArabic: 'qqqqq', unit: 'kg', availability: '100', availabilityBranch: '50', requestedQty: '40', scanQty: '80', shippedQty: '80', receivedQty: '80', remQty: '20' },
    { itemno: '2', productname: 'Rice', productnameArabic: 'qqqqq', unit: 'kg', availability: '100', availabilityBranch: '50', requestedQty: '40', scanQty: '80', shippedQty: '80', receivedQty: '80', remQty: '20' },
    { itemno: '3', productname: 'Rice', productnameArabic: 'qqqqq', unit: 'kg', availability: '100', availabilityBranch: '50', requestedQty: '40', scanQty: '80', shippedQty: '80', receivedQty: '80', remQty: '20' },
    { itemno: '4', productname: 'Rice', productnameArabic: 'qqqqq', unit: 'kg', availability: '100', availabilityBranch: '50', requestedQty: '40', scanQty: '80', shippedQty: '80', receivedQty: '80', remQty: '20' },
    { itemno: '5', productname: 'Rice', productnameArabic: 'qqqqq', unit: 'kg', availability: '100', availabilityBranch: '50', requestedQty: '40', scanQty: '80', shippedQty: '80', receivedQty: '80', remQty: '20' },
    { itemno: '6', productname: 'Rice', productnameArabic: 'qqqqq', unit: 'kg', availability: '100', availabilityBranch: '50', requestedQty: '40', scanQty: '80', shippedQty: '80', receivedQty: '80', remQty: '20' }

  ];
  columnDefs = [
    { headerName: 'Item Name', field: 'productname', sortable: true, filter: true, width: 100 },
    { headerName: 'Variant', field: 'variant', sortable: true, filter: true, width: 90 },
    { headerName: 'Batch No.', field: 'batchNo', sortable: true, filter: true, width: 100 },
    ...
    { headerName: 'Reason', field: 'reason', sortable: true, filter: true, width: 100 },
    { headerName: '', field: '', width: 30 }
    
  ];

  rowData = [
    { productname: 'Rice', variant: 'Basmati', batchNo: '01', expiryDate: '24/09/2020', availableQty: '100', reqQty: '80', reason: 'Damaged' },
    { productname: 'Rice', variant: 'Basmati', batchNo: '01', expiryDate: '24/09/2020', availableQty: '100', reqQty: '80', reason: 'Damaged' },
    { productname: 'Rice', variant: 'Basmati', batchNo: '01', expiryDate: '24/09/2020', availableQty: '100', reqQty: '80', reason: 'Damaged' },
    { productname: 'Rice', variant: 'Basmati', batchNo: '01', expiryDate: '24/09/2020', availableQty: '100', reqQty: '80', reason: 'Damaged' },
    { productname: 'Rice', variant: 'Basmati', batchNo: '01', expiryDate: '24/09/2020', availableQty: '100', reqQty: '80', reason: 'Damaged' },
